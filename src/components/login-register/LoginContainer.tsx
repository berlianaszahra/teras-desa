...
export default function LoginContainer() {
    ...
    return (
        <div
            className="min-h-screen w-full flex flex-col bg-cover bg-center absolute inset-0 bg-black/20"
        ...
        >
            ...
            <div className="flex-1 flex items-center justify-center">
                <div className="relative flex shadow-2xl w-[881px] h-[554px]">
                    ...
                    {/* kanan */}
                    <div className="absolute right-0 top-0 h-full w-1/2 p-10 flex flex-col justify-center text-white text-center gap-4 
