  ...
  return (
    <section className="w-full flex justify-center py-12 md:py-20 lg:py-24 bg-[#F5F1E9]">
      ...
      <div className="w-full max-w-[1196px] px-4 md:px-10 flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
        ...
        {/* LEFT */}
        <div className="relative w-full max-w-[500px] h-[350px] md:h-[450px] lg:w-[596px] lg:h-[513px] rounded-2xl md:rounded-[30px] overflow-hidden">

          {/* background kotak */}
          <div className="absolute inset-0 bg-[#3F5210] rounded-2xl md:rounded-[30px] z-0" />

          {/* lingkaran */}
          <div className="absolute w-[70%] h-[70%] bg-[#2F3E0C] rounded-full top-6 left-6 md:top-8 md:left-10 z-10" />

          {/* gambar */}
          <img
            src="/images/bapak.webp"
            alt="Image Bapak Desa"
            className="absolute w-[80%] max-w-[474px] h-auto top-[-40px] md:top-[-60px] left-[10%] z-20"
          />
        </div>
